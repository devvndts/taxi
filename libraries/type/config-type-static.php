...
$config['static'][$nametype]['width2'] = 400;
$config['static'][$nametype]['height2'] = 400;
/* Tại sao chọn chúng tôi Trang chủ */
$nametype = "tai-sao-choose";
$config['static'][$nametype]['title_main'] = "Tại sao chọn chúng tôi Trang chủ";
$config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['static'][$nametype]['images'] = true;
...
$config['static'][$nametype]['seo'] = true;
$config['static'][$nametype]['width'] = 1920;
$config['static'][$nametype]['height'] = 590;
$config['static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['static'][$nametype]['file_type'] = '.doc|.docx|.pdf|.rar|.zip|.ppt|.pptx|.xls|.xlsx|.jpg|.png|.gif';
$config['static'][$nametype]['images2'] = false;
$config['static'][$nametype]['width2'] = 400;
...
$nametype = "our-info";
$config['static'][$nametype]['title_main'] = "Thông Tin Của Chúng Tôi";
$config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
